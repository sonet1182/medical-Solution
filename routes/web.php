...
Route::group(['middleware' => ['auth', 'isAdmin']], function () {
    ...
    Route::get('/registered-ambulance', [AdminController::class, 'index2']);
...
Route::group(['middleware' => ['auth', 'isUser']], function () {
    ...
    Route::get('notify', [UserController::class, 'note']);
});
...
Route::get('hospital/{id}', [GroupController::class, 'product']);
Route::get('ambulance/{id}', [GroupController::class, 'product2']);

//Route::get('service',[GroupController::class,'service']);