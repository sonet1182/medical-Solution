                            ...
                            <div class="card-body">
                                <form action="{{ url('update_sub_category/'. $sub_category->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="map" class="form-control" id="" rows="4" value="{{ $sub_category->map }}">{{ $sub_category->map }}</textarea>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="phone" class="form-control" id="exampleInputEmail1"  value="{{ $sub_category->phone }}">
                                    </div>
